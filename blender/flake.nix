    ...
    in {
      ...
      overlays.default = final: prev: {
        ...
        blender_3_3 = mkBlender {
          ...
          version = "3.3.11";
          src = import <nix/fetchurl.nix> {
            url = https://ftp.nluug.nl/pub/graphics/blender/release/Blender3.3/blender-3.3.11-linux-x64.tar.xz;
            hash = "sha256-L67soL/SVlOMn7nmo2yS+/HoJbJY/aJk0fYTWDbapUA=";
          };
        };
        ...
        blender_3_6 = mkBlender {
          ...
          version = "3.6.4";
          src = import <nix/fetchurl.nix> {
            url = https://ftp.nluug.nl/pub/graphics/blender/release/Blender3.6/blender-3.6.4-linux-x64.tar.xz;
            hash = "sha256-S7GNkEPcs6j/X/vVblp4PHgYTWXeUcxSKQGo9HuhMKk=";
          };
        };
      };
